...
/**
 * Perform MD5 transformation on the given data.
 *
 * @param ctx Pointer to the MD5 context structure
 * @param data Array of uint8_t data to be transformed
 *
 * @return void
 *
 * @throws None
...
/**
 * Updates the MD5 context with the given data.
 *
...
/**
 * Generates the final MD5 hash based on the given MD5 context.
 *
 * @param ctx pointer to the MD5 context struct
 * @param hash array to store the final hash
 *
 * @return void
 *
 * @throws None
