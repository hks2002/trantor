 ...
 *
 */
std::function<void()> &Logger::flushFunc_(size_t index) {
 ...
 *
 */
std::function<void(const char *msg, const uint64_t len)> &Logger::outputFunc_() {
 ...
 *
 */
std::function<void(const char *msg, const uint64_t len)> &Logger::outputFunc_(size_t index) {
 ...
 */
void Logger::setOutputFunction(std::function<void(const char *msg, const uint64_t len)> outputFunc,
