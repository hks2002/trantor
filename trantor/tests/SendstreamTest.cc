...
int main(int argc, char *argv[]) {
  ...
  int counter = 0;
  server.setConnectionCallback([argv, &counter](const TcpConnectionPtr &connPtr) {
...
#endif
          auto callback = std::bind(fileCallback, argv[1], fd, std::placeholders::_1, std::placeholders::_2);
