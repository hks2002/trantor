...
#ifndef TRANTOR_LOCK_FREE_QUEUE_H
#define TRANTOR_LOCK_FREE_QUEUE_H
...
public:
  MpscQueue() : head_(new BufferNode), tail_(head_.load(std::memory_order_relaxed)) {}
  ~MpscQueue() {
    T output;
...
#endif  // TRANTOR_LOCK_FREE_QUEUE_H
