...
TEST(InetAddress, toIpPortNetEndianTest) {
  EXPECT_EQ(std::string({char(192), char(168), 0, 1, 0, 80}), InetAddress("192.168.0.1", 80).toIpPortNetEndian());
  EXPECT_EQ(std::string({0x20,
                         ...
                         1,
                         char(187)}),
            InetAddress("2001:0db8:3333:4444:5555:6666:7777:8888", 443, true).toIpPortNetEndian());
}
