...
TEST(splitString, ACCEPT_EMPTY_STRING1) {
  ...
  auto        out          = utils::splitString(std::move(originString), ",", true);
...
TEST(splitString, ACCEPT_EMPTY_STRING8) {
  std::string originString = "trantor:::splitString";
  auto        out          = utils::splitString(std::move(originString), "trantor:::splitString", true);
  EXPECT_EQ(out.size(), 2);
...
TEST(splitString, NO_ACCEPT_EMPTY_STRING1) {
  std::string originString = ",1,2,3";
  auto        out          = utils::splitString(std::move(originString), ",");
  EXPECT_EQ(out.size(), 3);
...
TEST(splitString, NO_ACCEPT_EMPTY_STRING7) {
  std::string originString = "trantor:::splitString";
  auto        out          = utils::splitString(std::move(originString), "trantor:::splitString");
  EXPECT_EQ(out.size(), 0);
}
